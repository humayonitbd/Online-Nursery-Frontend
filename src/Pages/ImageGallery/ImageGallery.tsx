...
//       img1,img2,img3,img4,img5,img7,img6,img8,img9,img10
     
//     ];
//     return (
//       <div className="p-4">
//         <h2 className="text-2xl font-bold mb-4 text-center">
//           Healthy Individuals Using Our Products
//         </h2>
...
//               />
//               <div className="absolute inset-0 bg-black bg-opacity-25 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg flex items-center justify-center">
